...
class GameObject:
    """
    Namespace class that manages game-global methods. Call __init__ on this class to reset game state variables.
    """
    ...
    def start_game():
        ...
        GameState.player_actor = ActorUnit(name=player_name, health=20, starter_weapon=weapon, hostility=0)
